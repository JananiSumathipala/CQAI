...
$pdf_web_path = "/SLAF/cqai-intra/admin/action/" . $file; // absolute from web root
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- PDF.js Viewer -->
<iframe src="/SLAF/cqai-intra/assets/pdfjs/web/viewer.html?file=<?= urlencode($pdf_web_path) ?>"
