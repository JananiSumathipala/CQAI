...
$stmt = $db->prepare("SELECT d.title, d.description, d.uploaded_at, d.file_path 
    ...
    WHERE d.category_id = 22 AND d.is_active = 1 AND d.branch_id = ?
...
<main class="container my-5 pt-5">
        <div class="page-header mb-4">
            <h3 class="colour-defult">Training <i class="fa fa-book"></i>
                <div class="float-end">
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <ul class="nav flex-column nav-pills" id="inspectorateTabs" role="tablist" aria-orientation="vertical">
                    <li class="nav-item">
                        <a class="nav-link active" id="org-tab" data-bs-toggle="pill" href="#outside_training" role="tab">Outside Training</a>
                    </li>
