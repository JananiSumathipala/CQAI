...
/*Table structure for table `publication documents` */
...
CREATE TABLE `publication_documents` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `uploaded_by` (`uploaded_by`) USING BTREE,
  KEY `fk_publication_document_category` (`category_id`) USING BTREE,
  CONSTRAINT `publication_documents_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `publication_categories` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `publication_documents_ibfk_2` FOREIGN KEY (`uploaded_by`) REFERENCES `admins` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
