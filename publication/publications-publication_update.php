...
$stmt = $db->prepare("SELECT d.title, d.description, d.uploaded_at, d.file_path 
    ...
    WHERE d.category_id = 13 AND d.is_active = 1 AND d.branch_id = ?
        ...
        <div class="row">
            <div class="col-lg-2">
                ...
                <ul class="nav flex-column nav-pills" id="inspectorateTabs" role="tablist" aria-orientation="vertical">
                    <li class="nav-item">
                        <a class="nav-link active" id="org-tab" data-bs-toggle="pill" href="#publication_update" role="tab">Publication Update</a>
                    </li>
